...
var HttpRequest = requestSdk_min.exports;
    ...
    header: (config) => {
        return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
            const signature = yield new Util({
                base: {
                    showMoneyBaseUrl: showMoneyBaseUrl
                }
            })
...
export { Address, MetaId, MetaIdProvider, Tx, Utxo, Xpub };
//# sourceMappingURL=metaid-provider-sdk.esm.js.map
