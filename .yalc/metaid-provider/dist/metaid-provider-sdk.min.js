(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('http'), require('https'), require('url'), require('stream'), require('assert'), require('tty'), require('util'), require('os'), require('zlib'), require('path'), require('fs'), require('mvc-lib')) :
    typeof define === 'function' && define.amd ? define(['exports', 'http', 'https', 'url', 'stream', 'assert', 'tty', 'util', 'os', 'zlib', 'path', 'fs', 'mvc-lib'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.MetaIdProviderSDK = {}, global.require$$1$1, global.require$$2, global.require$$0$3, global.require$$3, global.require$$4, global.require$$0$2, global.require$$1, global.require$$0$1, global.require$$8, global.require$$1$2, global.require$$6, global.mvc));
})(this, (function (exports, require$$1$1, require$$2, require$$0$3, require$$3, require$$4, require$$0$2, require$$1, require$$0$1, require$$8, require$$1$2, require$$6, mvc) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    } (requestSdk_min, requestSdk_min.exports));
    ...
    class Address extends BaseApi {
        ...
        getProtocols(params) {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                const res = yield serviceapi(this.getShowMoneyBaseUrl(params.option))
...
//# sourceMappingURL=metaid-provider-sdk.min.js.map
